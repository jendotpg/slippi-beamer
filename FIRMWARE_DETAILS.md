...
| Label           | What happened                                                                                                                                                                                                                                                                                                                         |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `NO ID`         | The board's factory MAC is unset or all zeroes.**This is a board-side hardware issue.**                                                                                                                                                                                                                                               |
| `NO SD CARD`    | The card slot came up empty or no card responded. **This is probably a microSD card hardware issue.**                                                                                                                                                                                                                                 |
| `SD UNREADABLE` | A card is present but a read failed after trying to recover for 30 seconds. **This is probably a microSD card hardware issue - try a different card.**                                                                                                                                                                                |
| `WRITE FAILED`  | A write to the card failed. The station will try to reinitialize it with no data loss. **If it happens once or twice, don't worry about it. If it keeps coming back, try a different card.**                                                                                                                                          |
| `CARD STUCK`    | The card got stuck after a write. The station will try to restart it. **If it happens once or twice, don't worry about it. If it keeps coming back, try a different card.**                                                                                                                                                           |
| `WRONG FORMAT`  | A card is readable but has no FAT32 partition or a first FAT32 partition bigger than 4 GB. **Reformat the microSD card**.                                                                                                                                                                                                             |
| `NO CONFIG`     | `CONFIG/config.txt` could not be read. **Fix config.txt.**                                                                                                                                                                                                                                                                            |
| `BAD CONFIG`    | The config file was read and rejected. **Fix config.txt.**                                                                                                                                                                                                                                                                            |
| `NO USB`        | The USB stack would not start.<br /><br />**This is a board-side hardware issue. Contact LilyGO support - feel free to reach out to me (Discord @jenpissgirl) for help.**                                                                                                                                                             |
| `RADIO FAILURE` | The ESP32 radio would not start.<br /><br />**This is a board-side hardware issue. Contact LilyGO support - feel free to reach out to me (Discord @jenpissgirl) for help.**                                                                                                                                                           |
...
| Label           | What is off                                                                                                                                                                                                                                                                                                        |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `DRIVE FAILING` | The card has stopped answering reads. Replays are still recorded, but not counted or served.**Replace your microSD card - it's reached the end of its life. This should be temporary (it turns into an error if it interrupts beamer operations).**                                                                |
